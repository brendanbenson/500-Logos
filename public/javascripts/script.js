$(document).ready(function () {
  ...
  var QUIZ = {
    ...
    buildquestion: function () {
      ...
      var choices = [this.question.choice1, this.question.choice2, this.question.choice3, this.question.correct];
    ...
    endquiz: function () {
      $('#logo').fadeOut(300, function () {
        var $logo = $('#logo');
        $logo.html('');
        $logo.append('<div id="topscores"><p><strong>Congratulations!</strong> Your score was <strong>' +
        QUIZ.formattime(QUIZ.score) +
        '</strong> seconds!</p><div id="scoreform"><table><tr><td><label for="scoreuser">' +
        '<strong>Your Name:</strong></label></td><td><input type="text" name="user" id="scoreuser" /></td><td>' +
        '<div id="submit" class="choice"><strong>Submit Score!</strong></div></td></tr></table></div></div>' +
